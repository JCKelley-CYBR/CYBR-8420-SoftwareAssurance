...
Although below in 3.5, there is an issue with authentiation to application via Windows Hello. In addition, all the above labelled security components are satisfactory.
